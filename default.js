// for OHIF Viewers\platform\app\public\config\default.js
...
window.config = {
  ...
  dataSources: [
    ...
    },
    {
      ...
      configuration: {
        name: 'FastAPI Source',
        wadoUriRoot: 'http://localhost:9999/dicom',
        qidoRoot: 'http://localhost:9999',
        wadoRoot: 'http://localhost:9999',
        imageRendering: 'wadors',
        thumbnailRendering: 'wadors',
        enableStudyLazyLoad: true,
        supportsFuzzyMatching: false,
    ...
    {
      namespace: '@ohif/extension-default.dataSourcesModule.dicomweb',
      sourceName: 'fastapi_local',
      configuration: {
        friendlyName: 'My FastAPI Local Server',
        name: 'fastapi_local',
        qidoRoot: 'http://localhost:9999/dicomweb',
        wadoRoot: 'http://localhost:9999/dicomweb',
        wadoUriRoot: 'http://localhost:9999/dicomweb',
        qidoSupportsIncludeField: false,
        supportsReject: false,
        imageRendering: 'wadors',
        thumbnailRendering: 'wadors',
